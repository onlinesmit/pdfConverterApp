    ...
    <div className='max-w-screen-2xl mx-auto container px-6 py-3 md:px-40'>
        <div className='flex h-screen items-center justify-center'>
            ...
            <div className='flex flex-col items-center space-y-4'>
                ...
                disabled={!selectedFile} className='text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-event-none duration-300 font-bold px-4 py-2 rounded-lg'>
                  Convert File
                </button>
